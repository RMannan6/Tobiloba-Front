    ...
    <div className="container-fluid">
      <div className="row">
        ...
        <div className="col-md-10">
          ...
          <div className="container-bright col-md-9">
            <div className="form-group">
              ...
              >
                <option>Select existing category from this dropdown</option>
                {categories.length > 0 &&
                  categories.map((c) => (
            ...
            <hr />
            <h4>{subs.length} existing tags </h4>
            <h6>across all categories.</h6>
            {/* {step5} */}
